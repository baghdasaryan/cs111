...
typedef struct process {
	...
	int p_priority;			// priority levels are defined here:
					// part 4A

	int p_proportional_share;	// used for proportional share
					// algortihm

	int p_running_time;		// used for storing the time a process
					// is up and running
